                                    ...
                                    >
                                        ...
                                        <div className="space-y-5 ml-2 sm:ml-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <motion.div
                                                    animate={{
                                                        boxShadow: aiGeneratedFields[`${question.id}-enunciado`]
                                                            ? '0 0 0 1px rgba(99,102,241,0.5), 0 0 14px rgba(99,102,241,0.2)'
                                                ...
                                                >
                                                    <Textarea
                                                        ...
                                                        className="resize-none bg-black/20 border-white/10 focus-visible:border-primary/50 transition-all rounded-lg p-3 w-full"
                                                    />
                                                </motion.div>
                                            </div>
